...
export const RaymarchShaderChunk: {[key: string]: string} = {
  /** @ignore */ raymarch_common_pars_fragment: raymarch_common_pars_fragment,
  /** @ignore */ ray_pars_fragment: ray_pars_fragment,
  /** @ignore */ distance_pars_fragment: distance_pars_fragment,
  /** @ignore */ raymarch_pars_fragment: raymarch_pars_fragment,
  /** @ignore */ raymarch_fragment: raymarch_fragment,
  /** @ignore */ raymarch_write_depth_fragment: raymarch_write_depth_fragment,
  /** @ignore  */ basic_get_material_pars_fragment: basic_get_material_pars_fragment,
  /** @ignore */ basic_material_pars_fragment: basic_material_pars_fragment,
  /** @ignore */ lambert_get_material_pars_fragment: lambert_get_material_pars_fragment,
  /** @ignore */ lambert_material_pars_fragment: lambert_material_pars_fragment,
  /** @ignore */ phong_get_material_pars_fragment: phong_get_material_pars_fragment,
  /** @ignore */ phong_material_pars_fragment: phong_material_pars_fragment,
  /** @ignore */ physical_get_material_pars_fragment: physical_get_material_pars_fragment,
  /** @ignore */ physical_material_pars_fragment: physical_material_pars_fragment,
  /** @ignore */ raw_color_pars_fragment: raw_color_pars_fragment,
  /** @ignore */ raymarch_fog_pars_fragment: raymarch_fog_pars_fragment,
  /** @ignore */ raymarch_fog_fragment: raymarch_fog_fragment,
  /** @ignore */ envmap_fragment: envmap_fragment,
  /** @ignore */ envmap_pars_fragment: envmap_pars_fragment,
  /** @ignore */ lights_lambert_fragment: lights_lambert_fragment,
  /** @ignore */ lights_lambert_pars_fragment: lights_lambert_pars_fragments,
  /** @ignore */ lights_fragment_begin: lights_fragment_begin,
  /** @ignore */ light_fragment_end: lights_fragment_end,

  /** @ignore */ raymarch_vert: raymarch_vert,
  /** @ignore */ raymarch_normal_frag: raymarch_normal_frag,
  /** @ignore */ raymarch_basic_frag: raymarch_basic_frag,
  /** @ignore */ raymarch_lambert_frag: raymarch_lambert_frag,
  /** @ignore */ raymarch_phong_frag: raymarch_phong_frag,
  /** @ignore */ raymarch_physical_frag: raymarch_physical_frag,
  /** @ignore */ raymarch_depth_frag: raymarch_depth_frag,
  /** @ignore */ raymarch_matcap_frag: raymarch_matcap_frag,
  /** @ignore */ raymarch_raw_frag: raymarch_raw_frag,
};